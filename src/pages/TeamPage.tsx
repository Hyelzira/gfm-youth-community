...
    
    // Other Team Leads
    { name: 'KWATRI VICTOR', role: 'EVERYTHING MOVIES ADMIN', image: '/src/assets/images/victor.jpg', unit: 'Movies Dept.' },
    { name: 'WAKAWA HIRHYEL', role: 'EVERYTHING POLITICS ADMIN', image: '/src/assets/images/joan.jpg', unit: 'Politics Dept.' },
    { name: 'PAM VICTORY', role: 'EVERYTHING BUSINESS ADMIN', image: '/src/assets/images/vic.jpg', unit: 'Business Dept.' },
    { name: 'FEMI JAMES', role: 'USHERS LEAD', image: '/src/assets/images/smile.jpg', unit: 'Service & Protocol' },
];
